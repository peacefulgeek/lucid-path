...
const categories: Category[] = [
  {
    ...
    products: [
      ...
      {
        name: "Dream Yoga — Andrew Holecek",
        url: amz("1622034589"),
        description: "The bridge between Western lucid dreaming and Tibetan dream yoga traditions. Holecek writes with clarity about practices that most teachers leave shrouded in mysticism. Essential for anyone drawn to the contemplative side of dream work.",
        isAmazon: true,
      },
      {
      ...
      {
        name: "Lucid Dreaming: A Concise Guide — Stephen LaBerge",
        url: amz("159179675X"),
        description: "A more accessible entry point than LaBerge's full research text. Includes guided exercises and the core techniques in a format you can work through in a weekend.",
        isAmazon: true,
      },
      {
  ...
  },
  {
    ...
    products: [
      {
        name: "Lucid Dreaming Dream Journal — Independently Published",
        url: amz("B0DQJRP5YQ"),
      ...
      {
        name: "Sweet Dreams — Dream Journal Kit with Sleep Mask",
        url: amz("B07DLFQ1Y6"),
        description: "A thoughtful starter kit that pairs a guided dream journal with a comfortable sleep mask. A good gift for someone curious about dream work.",
        isAmazon: true,
      },
    ],
  },
  {
    ...
    products: [
      ...
      {
        name: "Alpha GPC 600mg — Choline Supplement",
        url: amz("B01EBUIWDQ"),
        description: "A choline precursor that supports acetylcholine production. Many experienced lucid dreamers stack this with galantamine for enhanced dream vividness and recall.",
        isAmazon: true,
      },
      {
        name: "Mugwort Herb — Organic Dried",
        url: amz("B07BFNM7PL"),
  ...
  },
  {
    ...
    products: [
      {
        name: "Manta Sleep Mask — 100% Blackout",
        url: amz("B07PRG2CQB"),
        description: "Total darkness is non-negotiable for quality REM sleep. The Manta's adjustable eye cups create zero-pressure blackout without touching your eyelids — critical for REM eye movement.",
        isAmazon: true,
      },
      {
        name: "Bluetooth Sleep Headphones — 3D Sleep Mask",
        url: amz("B0CX4YJ5Y7"),
        description: "Combines a blackout mask with flat speakers for binaural beats or guided meditations. Useful for WILD technique practitioners who use audio cues during the hypnagogic transition.",
        isAmazon: true,
      ...
      },
      {
        ...
        url: amz("B0C5S7K1JK"),
        description: "A gentle sunrise simulation that supports natural wake-ups during lighter sleep stages — ideal for dream recall. The programmable wind-down routines also help with pre-sleep meditation practice.",
        isAmazon: true,
      },
    ],
  },
    ...
    products: [
      {
        ...
        url: amz("B0002046F8"),
        description: "Meditation is the foundation of sustained lucid dreaming practice. A proper zafu makes the difference between a practice you maintain and one you abandon. This one is made in the USA and lasts for years.",
        isAmazon: true,
      ...
      },
      {
        ...
        url: amz("B07XLHC1Z5"),
        description: "Sound meditation before sleep helps quiet the mental chatter that blocks dream awareness. The resonance of a singing bowl creates a natural anchor point for pre-sleep mindfulness.",
        isAmazon: true,
      },
      {
