...
function ensureMinimumAmazonLinks(body) {
  ...
  const UNIVERSAL_PRODUCTS = [
    { name: "Exploring the World of Lucid Dreaming", asin: "034537410X", embed: `Stephen LaBerge's <a href="https://www.amazon.com/dp/034537410X?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">Exploring the World of Lucid Dreaming</a> <em>(paid link)</em> remains the most practical guide for developing these skills.` },
    { name: "Lucid Dreaming: Gateway to the Inner Self", asin: "193049114X", embed: `Robert Waggoner's <a href="https://www.amazon.com/dp/193049114X?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">Lucid Dreaming: Gateway to the Inner Self</a> <em>(paid link)</em> explores what becomes possible once awareness stabilizes in the dream state.` },
    { name: "Are You Dreaming?", asin: "0957497709", embed: `Daniel Love's <a href="https://www.amazon.com/dp/0957497709?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">Are You Dreaming?</a> <em>(paid link)</em> covers the practical techniques in detail.` },
    { name: "Why We Sleep", asin: "1501144324", embed: `Matthew Walker's <a href="https://www.amazon.com/dp/1501144324?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">Why We Sleep</a> <em>(paid link)</em> is essential for understanding the science behind quality sleep and dreaming.` },
    { name: "Dreams of Awakening", asin: "1781802025", embed: `Charlie Morley's <a href="https://www.amazon.com/dp/1781802025?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">Dreams of Awakening</a> <em>(paid link)</em> bridges Western lucid dreaming with Tibetan Buddhist dream yoga traditions.` },
    { name: "Dream Journal", asin: "B09T39P48Z", embed: `A dedicated <a href="https://www.amazon.com/dp/B09T39P48Z?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">dream journal</a> <em>(paid link)</em> by the bed makes dream journaling effortless.` },
    { name: "MZOO Sleep Mask", asin: "B0B14QQV6R", embed: `Total darkness supports deeper REM sleep. A quality <a href="https://www.amazon.com/dp/B0B14QQV6R?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">contoured sleep mask</a> <em>(paid link)</em> blocks all light without pressing on the eyelids.` },
    { name: "Natrol Melatonin", asin: "B00DKEUBIE", embed: `For better sleep quality, <a href="https://www.amazon.com/dp/B00DKEUBIE?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">melatonin supplements</a> <em>(paid link)</em> can help regulate your sleep-wake cycle for dream practice.` },
    { name: "White Noise Machine", asin: "B07RWRJ4XW", embed: `A <a href="https://www.amazon.com/dp/B07RWRJ4XW?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">white noise machine</a> <em>(paid link)</em> creates the consistent sleep environment that supports uninterrupted dream cycles.` },
    { name: "The Tibetan Yogas of Dream and Sleep", asin: "1559391014", embed: `Tenzin Wangyal Rinpoche's <a href="https://www.amazon.com/dp/1559391014?tag=${AMAZON_TAG}" target="_blank" rel="nofollow noopener">The Tibetan Yogas of Dream and Sleep</a> <em>(paid link)</em> takes dream practice into the territory of spiritual awakening.` },
  ];
